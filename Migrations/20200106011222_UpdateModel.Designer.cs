...
namespace UniversityDemo.Migrations
{
    ...
    [Migration("20200106011222_UpdateModel")]
            ...
            modelBuilder.Entity("UniversityDemo.Models.StudentModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StudentId = 1,
                            EnrollmentDate = new DateTime(2020, 1, 5, 20, 12, 21, 723, DateTimeKind.Local).AddTicks(7770),
                            FirstName = "William",
                        ...
                        {
                            StudentId = 2,
                            EnrollmentDate = new DateTime(2020, 1, 5, 20, 12, 21, 743, DateTimeKind.Local).AddTicks(5890),
                            FirstName = "James",
                            LastName = "Blake"
                        },
                        new
                        {
                            StudentId = 3,
                            EnrollmentDate = new DateTime(2020, 1, 5, 20, 12, 21, 743, DateTimeKind.Local).AddTicks(5940),
                            FirstName = "Franklin",
                            LastName = "Stein"
                        },
                        new
